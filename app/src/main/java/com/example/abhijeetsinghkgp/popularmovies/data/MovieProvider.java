...
public final class MovieProvider {
    ...
    @TableEndpoint(table = MovieDatabase.MOVIE_TRAILERS) public static class MovieTrailers{
        @ContentUri(
        ...
        @InexactContentUri(
                ...
                join = MovieDatabase.MOVIE_REVIEWS,
                pathSegment = 1)
        public static Uri withId(String id){
    ...
    @TableEndpoint(table = MovieDatabase.MOVIE_REVIEWS) public static class MovieReviews{
        @ContentUri(
